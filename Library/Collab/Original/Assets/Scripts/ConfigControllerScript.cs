...
public class ConfigControllerScript : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        GameObject context = GameObject.FindGameObjectWithTag("Context");
        player = context.GetComponent<GameContextScript>().getPlayer();
    ...
    public static void buildPlayer(){
        ...
        //PrefabUtility.ReplacePrefab(playerClone, prefab, ReplacePrefabOptions.ConnectToPrefab);


        GameObject context = GameObject.FindGameObjectWithTag("Context");
        context.GetComponent<GameContextScript>().setPlayer(player);
